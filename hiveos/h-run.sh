...

{
  ...
  echo "OPTIMIZATION=BLAKE3_MIDSTATE GPU_TARGET_FILTER PERSISTENT_RESULT LIVE_HASHRATE AUTOTUNED_PIPELINE EXACT_BIT_CONVERSIONS FAST_FRACTION ZERO_NIBBLE_SKIP HASHMOD_HOIST PREFER_L1"
...

{
  ...
  echo "Optimizations: autotuned monolithic/split pipeline; exact bit conversions; exact fast fraction; zero-nibble skip; hash-mod conversion hoist; PreferL1; persistent buffers; 524288 runtime batch"
